...
import { allSelectedTraining } from '../../redux/reducers/selectedTrainingReducer';
...
function TrainingsPage() {
  ...
  const openUpdateTrainingDialog = (e) => {
    ...
    dispatch(allSelectedTraining(training));
    ...
    <Grid container>
      ...
      <Grid item xs={10}>
        <Box display='flex' flexDirection='column' alignItems='center'>
          <Typography sx={{ mb: '1rem', mt: '1rem' }} variant='h4'>
            Trainings
          </Typography>
          <Button onClick={() => setDialogIsOpen(true)} sx={{ mb: '1rem' }} variant='contained'>
            Add a New Training
          </Button>
        </Box>
            ...
            <TableBody>
              {trainings.map((training) => (
                <TableRow key={training.id}>
                  ...
                  <TableCell>
                    <Button data-training_id={training.id} onClick={deleteTraining} variant='outlined' color='error'>
                      Delete Training
                    </Button>
                  </TableCell>
                </TableRow>
